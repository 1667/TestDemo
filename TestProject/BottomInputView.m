...
-(void)textViewDidChange:(UITextView *)textView
{
    ...
    CGRect frame = [self.textView.text boundingRectWithSize:CGSizeMake(SCREEN_W-90, MAXFLOAT) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:self.textView.font} context:nil];
    CGSize size = frame.size;
    [Utils NSLogWrite:[NSValue valueWithCGSize:size] Str:@"ffff"];
    ...
    [Utils NSLogWrite:[NSNumber numberWithFloat:lastHight] Str:@"lastHeig"];
}
